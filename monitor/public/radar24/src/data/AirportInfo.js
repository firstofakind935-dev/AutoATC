const airports = {
    ...
    // --- AutoATC additions below: airports AutoATC tracks that 24radar's own
    // reference data doesn't cover. No official ptfs-charts ground chart or
    // frequency data is available for these, so ChartsLinkPath is null and
    // frequencies are left null (matches how this file already represents
    // "unknown" for existing airports above).
    "ITRC": {
